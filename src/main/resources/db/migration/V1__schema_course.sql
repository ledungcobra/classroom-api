...
ALTER TABLE Assignments  ADD  CONSTRAINT `FK_Assignments_Course_CourseId` FOREIGN KEY(`CourseId`)
    REFERENCES Course (`Id`);


ALTER TABLE Assignments_Student  ADD  CONSTRAINT `FK_Assignments_Student_Assignments_AssignmentId` FOREIGN KEY(`AssignmentId`)
    REFERENCES Assignments (`Id`);


ALTER TABLE Assignments_Student  ADD  CONSTRAINT `FK_Assignments_Student_Student_StudentId` FOREIGN KEY(`StudentId`)
    REFERENCES Student (`Id`);


ALTER TABLE CourseStudent  ADD  CONSTRAINT `FK_CourseStudent_Course_CourseId` FOREIGN KEY(`CourseId`)
    REFERENCES Course (`Id`);
...
ALTER TABLE CourseUser  ADD  CONSTRAINT `FK_CourseUser_Course_CourseId` FOREIGN KEY(`CourseId`)
    REFERENCES Course (`Id`);


ALTER TABLE Grade  ADD  CONSTRAINT `FK_Grade_Assignments_AssignmentId` FOREIGN KEY(`AssignmentId`)
    REFERENCES Assignments (`Id`);
...
ALTER TABLE StudentNotification  ADD  CONSTRAINT `FK_StudentNotification_Student_StudentId` FOREIGN KEY(`StudentId`)
    REFERENCES Student (`Id`);
